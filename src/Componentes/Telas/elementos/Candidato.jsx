...
export default function Candidato(props) {
    ...
    function adicionarCurtida(candidato){
        candidato.curtidas = candidato.curtidas+1;
        setcurtidas(candidato.curtidas+1);// precisa instanciar como elemento pro react atualizar
    }

    function adicionarDescurtida(candidato){
            candidato.descurtidas = candidato.descurtidas+1;
            setdescurtidas(candidato.descurtidas+1);
    }
        ...
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <Button variant="primary"
                    onClick={()=>{
                        adicionarCurtida(props.candidato)
                    }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                        ...
                        onClick={()=>{
                        adicionarDescurtida(props.candidato)
                    }}>
                ...
                <Button onClick={()=>{
                    props.setCandidatoAtual({
                        id: props.candidato.id,
                        email: props.candidato.email,
                        nome: props.candidato.nome,
                        avatar: props.candidato.avatar,
                        propostas: props.candidato.propostas,
                        curtidas: props.candidato.curtidas,
                        descurtidas: props.candidato.descurtidas,
                        questionamentos: props.candidato.questionamentos
                    });
                    props.setDetalharC(true);
                }}
                className="mt-1" variant="success">Conheça minhas propostas</Button>
            </Card.Body>
        </Card>
    );
}